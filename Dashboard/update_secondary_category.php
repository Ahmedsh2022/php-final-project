...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (count($errors) > 0) {
        ...
        $query5 = "UPDATE secondary_categories 
        SET name='$name', description='$description', pc_id= '$pc_id'
        where id='" . $_GET['id']."'";
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query2 = "select * from secondary_categories  where id = '$id'";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Update Secondary Category</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" method="post" action=" <?php echo $_SERVER['PHP_SELF'] . "?id=" . $_GET['id'] ?>">
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-user"></i>Update Secondary Category</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Category Name</label>
                                                            <input type="text" id="projectinput1" class="form-control" value="<?php echo $row2['name']; ?>" placeholder="Category Name" name="c_name">
                                                            <?php
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="pc_id" class="form-control mx-auto">
                                                                <option value="empty">Choose Primary Category</option>
                                                                <?php
                                                                ...
                                                                if (mysqli_num_rows($result1) > 0) {
                                                                    while ($row1 = mysqli_fetch_assoc($result1)) {
                                                                        if ($row2['pc_id'] == $row1['id']) {
                                                                            echo "<option class='' value='" . $row1['id'] . "' Selected>" . $row1['name'] . "</option>";
                                                                        } else {
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <br>
                                                            <textarea class="form-control" id="projectinput2" rows="3" name="c_description"><?php echo $row2['description'] ?></textarea>
                                                            <?php
