        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><?php #echo strtoupper($user)
                                                                                                                                    ?></a>
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        ...
                                        <p class="news-content">
                                            <span class="font-small-2">January 26, 2022</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="col-md-3">
                                ...
                                <div id="accordionWrap" role="tablist" aria-multiselectable="true">
                                    <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                        <div class="card-header p-0 pb-2 border-0" id="headingOne" role="tab"><a data-toggle="collapse" data-parent="#accordionWrap" href="#accordionOne" aria-expanded="true" aria-controls="accordionOne">Accordion
                                                Item #1</a></div>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        ?>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="update_admins.php?id=<?php echo $row9['id'] ?>"><i class="ft-user"></i>
                                Edit Profile</a>
